...
def main():
    ...
    parser.add_argument("-q", "--query", type=str, required=True, help="SQL query")
    parser.add_argument("-o", "--output", type=str, default="result.parquet", help="Output file path for download")
